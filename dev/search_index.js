...

{
    ...
    "category": "section",
    "text": "The source code of this project is licensed under the MIT license. All MPI data is licensed under the CC BY 4.0 license. This implies that you are free to use, share, and adapt the data. However, you must give appropriate credit by citing the project. In particular we ask you to cite this publication."
},
...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "The provided MPI data can be read from any programming language like Matlab, Python, Julia, and C. On the MDF website example scripts for reading MDF data from Matlab, Python, and Julia are available.All data can be found under the following link. To simplify the data download and to provide example reconstructions this project also contains dedicated programming tools. These tools are written in the scientific programming language Julia and can be freely used. They are not strictly necessary if you want to use your own reconstruction methods.In order to install the programming tools you first have to install Julia in version 1.1 or newer. Then open Julia and enterusing Pkg\nPkg.add(url=\"https://github.com/MagneticParticleImaging/OpenMPIData.jl.git\")which will install the package. Then enterusing OpenMPIData\ndownloadOpenMPIData()The first command will import the OpenMPIData package, the second command will download all MPI data which can last several minutes up to hours depending on the speed of your internet connection.The downloadOpenMPIData() function will not download all of the open MPI data. The high resolution MPI system functions need to be manually downloaded using the commanddownloadCalibrationDataHighRes()To download the datasets for 1D, 2D, 3D or the system functions individually, use: download1DData()\n download2DData()\n download3DData()\n downloadCalibrationDataLowRes()\n downloadCalibrationDataHighRes()"
},
...

{
    ...
    "category": "section",
    "text": "(Image: Bruker Preclinical MPI Scanner)The preclinical MPI scanner from Bruker has a 118 mm bore and is equipped with a fully 3D send/receive system and 3D focus fields allowing for flexible measurement sequencies. The system parameters are given belowParameter Value\nScanner Bore Diameter 118 mm\nMaxDrive-Field Amplitude 14 mT x 14 mT x 14 mT\nMaxFocus-Field Amplitude 17 mT x 17 mT x 42 mT\nDrive-Field Frequency 2.5MHz/102 x 2.5MHz/96 x 2.5MHz/99\nMax Selection-Field Gradient -1.25 T/m x -1.25 T/m x 2.5 T/m\nRepetition Time 38.4 mus - 21.54 ms"
},
